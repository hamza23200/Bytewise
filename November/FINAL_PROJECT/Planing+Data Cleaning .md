...
def get_jobs(keyword, num_jobs, verbose,path):
    ...
    driver = webdriver.Chrome(executable_path=path, options=options) #YOUR OWN PATH
...
```python
import glassdoor scraper as gs
import pandas as pd
path="C: /Users/hamza/documents/proj/chromedriver"
